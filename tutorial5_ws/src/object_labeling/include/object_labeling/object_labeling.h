...
private:
  ...
  int findMatch(const darknet_ros_msgs::BoundingBox& rect, const std::vector<Eigen::Vector2d>& centroids);
...
private:
  ...
  ros::Publisher no_object_pub_;
  ros::Publisher no_cup_pub_;  // Add this to notify when no cup is found
