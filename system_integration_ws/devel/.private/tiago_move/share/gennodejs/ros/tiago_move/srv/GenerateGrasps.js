...
class GenerateGraspsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GenerateGraspsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GenerateGraspsRequest
    let len;
    let data = new GenerateGraspsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GenerateGraspsRequest(null);
...
class GenerateGraspsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GenerateGraspsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GenerateGraspsResponse
    let len;
    let data = new GenerateGraspsResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'tiago_move/GenerateGraspsResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GenerateGraspsResponse(null);
...
module.exports = {
  ...
  md5sum() { return '6ba1ad78917aa4c23b081fd0be1a2270'; },
  datatype() { return 'tiago_move/GenerateGrasps'; }
};
